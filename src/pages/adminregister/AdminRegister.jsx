...
const Register=()=>{
    ...
    const handleSubmit=async (e)=>{
        ...
        setError(false);
        try{
            const res=await axios.post("http://localhost:5000/server/auth/admin/register",{
                username,
                email,
                mobile,
                password
            });
            res.data && window.location.replace("/admin/login")
    ...
    return(
        <>
            <div className="register">
              <span className="registerTitle"> Admin Register</span>
